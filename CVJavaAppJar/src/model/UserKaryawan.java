 ...
 */
@Entity
public class UserKaryawan implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof UserKaryawan)) {
            return false;
        }
        UserKaryawan other = (UserKaryawan) object;
    ...
    public String toString() {
        return "model.UserKaryawan[ id=" + id + " ]";
    }
